...
(Unc-AUROC 0.881 vs.\ 0.722 in the unified comparison bundle). If the purpose of uncertainty is to support
...
scaling does not improve the operating points tracked in this repository and
it worsens the reported ECE values in the unified comparison bundle.
