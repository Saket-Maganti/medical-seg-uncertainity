...
\begin{enumerate}[leftmargin=*]
  ...
  far better than MC Dropout in our experiments
  ...
  calibration fix, does not improve the deferral operating points we measured. In our main runs it worsens the reported ECE
